...
public final class IO {
    ...
    public IO() {
        if (!initialized) {
            Axis.DriverLeftX.addTransform(deadbandTransform(0.075).andThen(exponentialTransform(30)));
            Axis.DriverLeftY.addTransform(deadbandTransform(0.075).andThen(exponentialTransform(30)));
            Axis.DriverRightX.addTransform(deadbandTransform(0.075).andThen(exponentialTransform(30)));
            Axis.DriverRightY.addTransform(deadbandTransform(0.075).andThen(exponentialTransform(30)));
